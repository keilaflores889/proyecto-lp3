...
class PaisDao:
    ...
    def getPaises(self):
        ...
        try:
            ...
            return [{'id_paises': pais[0], 'descripcion': pais[1]} for pais in paises]
    ...
    def guardarPais(self, descripcion):
        ...
        insertPaisSQL = """
        INSERT INTO paises(descripcion) VALUES(%s) RETURNING id_paises
        """
